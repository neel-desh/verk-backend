defmodule Verk.Supervisor do
  ...
  defp children do
    ...
    redis = case Keyword.keyword?(redis_url) do
      false -> worker(Redix, [redis_url, [name: Verk.Redis]], id: Verk.Redis)
      true -> worker(Redix, [redis_url ++ [name: Verk.Redis]], id: Verk.Redis)
    end
